                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                Η Πλατφόρμα συλλέγει περιεχόμενο (αρχεία εικόνας/ήχου και κείμενα), το οποίο στη συνέχεια χρησιμοποιείται από τη συνοδευτική βοηθητική εφαρμογή. Αυτό το περιεχόμενο χρησιμοποιείται στη συνέχεια ως πρόσθετο περιεχόμενο για την υποστηρικτική εφαρμογή στην οποία η πλατφόρμα λειτουργεί ως συνοδευτικό. Ο χρήστης συνιστάται αυστηρά να συμμορφώνεται με τον "κώδικα δεοντολογίας για επιτυχή συμμετοχή" της πλατφόρμας και να αποφεύγει τη δημόσια ανάρτηση προσωπικών δεδομένων που δεν επιθυμεί να είναι δημόσια διαθέσιμα στην πλατφόρμα.
                            ...
                            <div class="col-12">
                                ...
                                <table class="table table-striped table-responsive table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>dianoia_marketplace_cookies_consent_selection, dianoia_marketplace_cookies_consent_targeting (Αποθηκεύει την κατάσταση συναίνεσης cookie του χρήστη για το συγκεκριμένο τομέα)
                                            <br><br>
                                            ...
                                            <br><br>
                                            remember_web_*, dianoia_marketplace_session (Όταν η εφαρμογή πρέπει να ‘θυμάται’ τους συνδεδεμένους χρήστες όσο αυτοί περιηγούνται στην Πλατφόρμα)
                                            <br><br>
                                    ...
                                    <tr>
                                        ...
                                        <td>_ga_J481BLE1ZH, _ga_LXY37H72ZY, _ga_FERSCC5RD4, _gat,_ga, _gcl_au, _gid: Τα cookies της Google Analytics χρησιμοποιούνται για να μετρηθεί η κυκλοφορία στην Πλατφόρμα. Αποθηκεύεται μια μοναδική συμβολοσειρά κειμένου  για να αναγνωρίσει το φυλλομετρητή, τη χρονική σήμανση για αλληλεπιδράσεις και το φυλλομετρητή/σελίδα-πηγή που οδήγησε το χρήστη στην Πλατφόρμα. Δεν αποθηκεύεται καμία ευαίσθητη πληροφορία.
