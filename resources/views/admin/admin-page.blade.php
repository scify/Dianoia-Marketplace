            ...
            <div class="content">
                                        ...
                                        <div class="modal-body mb-5">
                                            <form id="form" enctype="multipart/form-data" role="form" method="POST"
                                                ...
                                                <div class="form-new__fields p-5">
                                                    <div class="col-12">
                                                        <label for="username" class="form-label">{{__('messages.name')}}
                                                            <span>*</span></label>
                                                        <input type="text" class="form-control" id="username"
                                                               name="name" value="{{$user->name}}">
                                                    </div>
                                                    <input style="display:none" type="text" class="form-control"
                                                           name="prev_type_id" value="{{$user->type->id}}">
                                                    ...
                                                    <div class="col-12">
                                                        <label for="password"
                                                               class="form-label">{{__('messages.password')}}
                                                            <span>*</span></label>
                                                    ...
                                                    <div class="col-12">
                                                        <label for="formGroupExampleInput2"
                                                               class="form-label">{{__('messages.user')}}</label>
                                                            ...
                                                            @foreach(['Private Carer', 'Professional Carer', 'Organization'] as $i=>$type)
                                                                @if($type === $user->type->name)
                                                                    <option value="{{$user->type->id}}"
                                                                            selected> {{trans('messages.'.$user->type->name)}}</option>
                                                                @else
                                                                    <option
                                                                        value="{{$i+2}}">{{trans('messages.'.$type)}} </option>
                                                                @endif
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="form-new__submmit-btn d-flex justify-content-end p-5">
                                                    <div>
                                                        ...
                                                        <a class="btn btn--secondary mt-1"
                                                           href="{{route('resources.my_profile')}}">
                                                            {{trans("messages.cancel")}}
                                                        </a>
                                                        <input id="userEditBtrn" class="btn btn--primary mt-1 ms-4"
                                                               type="submit" value="{{__('messages.submit-info')}}">
                                                    </div>
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="pending-exercises-tab" data-bs-toggle="tab"
                                        ...
                                        aria-selected="true">Pending Exercises
                                </button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="accepted-exercises-tab" data-bs-toggle="tab"
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="reported-exercises-tab" data-bs-toggle="tab"
                                        data-bs-target="#reported"
                                        type="button" role="tab" aria-controls="reported" aria-selected="false">Reported
                                    Exercises
                                </button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="rejected-exercises-tab" data-bs-toggle="tab"
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="pending" role="tabpanel"
                         aria-labelledby="pending-exercises-tab">
                        <div class="row">
                            <div class="col">
