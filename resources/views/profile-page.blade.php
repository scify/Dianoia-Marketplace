    ...
    <main class="content">
        ...
        <div class="tab-content" id="myTabContent">
                    ...
                    <div class="exercise-box" id="patient-template">
                        <div class="exercise-title-row">
                            <div class="description">
                                ...
                                <p>Αντιγράψτε τα σχέδια, σκιάζοντας τα αντίστοιχα τετράγωνα. Αντιγράψτε τα σχέδια,
                                    σκιάζοντας τα αντίστοιχα τετράγωνα. Αντιγράψτε τα σχέδια, σκιάζοντας τα αντίστοιχα
                                    τετράγωνα. </p>

                            </div>
                            <div>
                                <i class="far fa-edit"></i> <a href="#" class="btn btn--secondary" target="_blank">Δες
                                    την άσκηση</a>
                            </div>
                        </div>
                        <hr>
            ...
            <div class="tab-pane fade" id="carer" role="tabpanel" aria-labelledby="carer-tab">
                ...
                <div class="exercise-template shadow content mb-5 mt-5">
                    <div class="exercise-box" id="registered-template">
