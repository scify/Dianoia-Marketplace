...
You can also create your own exercises and if you wish to, you can share them with the community.',
    ...
    'about_development_text' => 'The "Dianoia" app was created by <a target="_blank" href="https://www.scify.org/en">The not-for-profit company SciFY</a> in the framework of the “Σημεία Στήριξης” program that is co-funded by the TIMA Foundation, the Latsis Foundation, the Hellenic Hope charity trust and the Bossodaki Foundation. <br><br> The initial version of the "Dianoia" app was developed with the scientific supervision and in cooperation with <a href="https://alzheimerathens.gr/" target="_blank">Alzheimer Athens</a>. <br> <br> More info can be found <a target="_blank" href="https://scify.org/en/project/%ce%b4%ce%b9%ce%ac%ce%bd%ce%bf%ce%b9%ce%b1/">here.</a>',
    'tutorial_video_link' => 'https://www.youtube.com/embed/hNHfDPX5jDM',
    'tutorial_video_prompt' => 'This tutorial is also available in video format:',
    'tutorial_title' => 'Tutorial',
    'tutorial_1' => '<b>Welcome to the Dianoia Marketplace!</b><br><br>A platform that we developed at SciFY to support people with emerging Dementia, as well as their carers. Through the platform, you can find activities and exercises tailored to every cognitive level, that in combination with pharmaceutical therapy can help the patient to remain functional, active, and have quality time, as well as tips for carers on how to manage patients regarding the exercises.',
    'tutorial_2' => 'These activities are divided into 3 categories:<br><br><b>1. Mental exercises, 2. Creative Activities, 3. Stories </b><br><br>Let’s see in detail what you can do with each:',
    'tutorial_3' => '<b>1. Mental exercises</b><br><br>Printable pencil and paper activities, divided into difficulty levels. Here we can find Focus activities, Memory, Speech & Thought, as well as Executive functions.',
    'tutorial_4' => '<b>2. Creative activities</b><br><br>Short activities from the patient’s daily routine',
    'tutorial_5' => '<b>3. Stories</b><br><br>Short, fun stories that after the patient reads the plot, there are separate small exercises for it.',
