...
class SimilarityCarerResourcesPackageManager extends CarerResourcesPackageManager {
    ...
    public function getApprovedSimilarityCarerPackagesParentResources(): DisplayPackageVM {
