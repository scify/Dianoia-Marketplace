...
class ResponseCarerResourcesPackageManager extends CarerResourcesPackageManager {
    ...
    public function getApprovedResponseCarerPackagesParentResources(): DisplayPackageVM {
